...
function performLogin($conn, $user, $remember = false) {
    ...
    // Redirect based on role: admin -> admin dashboard, scout -> scout page, others -> home
    $role = !empty($user['role']) ? strtolower($user['role']) : '';
    if ($role === 'admin') {
        header('Location: index.php?page=admin');
    } elseif ($role === 'scout') {
        header('Location: index.php?page=scout-approved-posts');
    } else {
