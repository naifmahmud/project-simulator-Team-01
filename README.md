...
A modern PHP MVC web application for managing travel destinations, built with PDO and prepared statements for security.
...
│   ├── ScoutController.php   # Scout dashboard
...
│   ├── scout-dashboard.php # Scout dashboard
